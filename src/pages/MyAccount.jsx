...
const MyAccount = () => {
  ...
  return (
    <div className="max-w-4xl mx-8 md:mx-auto mt-8 sm:mt-12 bg-white dark:bg-gray-900 rounded-3xl shadow-lg overflow-hidden border border-gray-100 dark:border-gray-700">
      {/* Banner */}
      <div className="h-20 sm:h-36 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500"></div>

      {/* Profile Section */}
      <div className="p-6 flex flex-col  md:items-center gap-8 -mt-20 sm:-mt-24">
        {/* Avatar */}
        <div className="flex flex-col items-center  flex-shrink-0">
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-1 text-center md:text-left">
            Supported: JPG, PNG, GIF (Max 20KB)
          </p>
        </div>
